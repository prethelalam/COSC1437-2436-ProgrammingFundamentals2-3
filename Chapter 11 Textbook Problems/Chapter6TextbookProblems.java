...
public class Chapter6TextbookProblems {
    ...
    public static void getColor(int choice)
    {
        RoulettePocket response = new RoulettePocket(choice);

        System.out.println(response.getPocketColor());
    }
    ...
    public static void displaySide()
    {
        ...
        for(int i = 0; i < 20; i++)
        {
            Coin sideChoice = new Coin();

            side = sideChoice.getSideUp();
